...
namespace OOPGSM
{
    class MobileDivice
    {
        ...
        private static MobileDivice iPhoneS4 = new MobileDivice("Apple", "iPhoneS4");
        ...
        public MobileDivice(string manufacturer, string model, Battery battery, Display display, string owner = null, decimal? price = null)
            : this(manufacturer, model)
        {
            this.model = model;
            this.manufacturer = manufacturer;
