        ...
        static void Main(string[] args)
        {

            {
                ...
                for (int r = 0; r < rows; r++)
                {
                  ...
                  //  Console.Write("{0}{1}", blankCells, fullCells); // We Print the blank and the full cells at once. The right side of the triangle is not fulled with blank characters but it can be if you wish:
                    Console.Write("{0}{1}{0}", blankCells, fullCells, blankCells);
